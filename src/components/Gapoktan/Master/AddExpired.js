...
import AddExpiredForm from "./AddExpiredForm";
  ...
  // Can be a string as well. Need to ensure each key-value pair ends with ;
    ...
    const handleSubmit = async (values) => {
        ...
        try{
            ...
            UserService.addMExpired(formData).then(
            async (response) => {
    ...
    if(redirect) {
        ...
        return <Redirect to="/ListLamaPenyimpanan" />;
            ...
            <Fragment>
                {(() => {
                    if (loading === true) {
                        ...
                        return(
                            <AddExpiredForm onSubmit={handleSubmit} />
                        )
                    }
                }
                )()}
