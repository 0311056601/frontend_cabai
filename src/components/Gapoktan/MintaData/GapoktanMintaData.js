...
export default class GapoktanMintaData extends Component {
  constructor(props) {
    super(props);
                                          ...
                                          <td className="py-2">
                                            {(() => {
                                              if(item.status === 'Menunggu Konfirmasi') {
                                                return(
                                                  <div>
                                                    <CButton size="sm" color="danger" onClick={() => this.approveRD(item)}>Approve</CButton> 
                                                    <CButton size="sm" color="warning" style={{ color:'white' }} className="ml-1" onClick={() => this.rejectRD(item)}>Reject</CButton>
                                                  </div>
                                                )
                                              }
                                            })()}
