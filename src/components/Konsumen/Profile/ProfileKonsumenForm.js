...
const ProfileKonsumenForm = (props) => {
      ...
      <main className="c-main">
        <div className="container-fluid">
          <CCard>
            <CCardHeader>
              <CRow>
                <CCol xs={9} md={10} lg={11} style={{ margin: "auto" }}>
                  <h4 style={{ margin: "auto" }}>Profile</h4>
                </CCol>
                <CCol>
                </CCol>
              </CRow>
            ...
            <CCardFooter>
              <CButton type="button" size="sm" color="warning" style={{color:"white"}} to="/ProfilKonsumen">
                Kembali
              </CButton> {" "}
...
export default reduxForm({
  form: "ProfileKonsumen", // a unique identifier for this form
})(ProfileKonsumenForm);
