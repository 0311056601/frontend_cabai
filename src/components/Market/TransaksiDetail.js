...
const TransaksiDetail = (props) => {
  ...
  const [gapoktan, setGapoktan] = useState(null);
    ...
    const getData = async () => {
        await UserService.getTransaksiDetail(transaksiId).then( async (response) => {
            ...
            if(response.data.message) {
                ...
                await UserService.GetInvoice(response.data.data.get_keranjang.no_transaksi).then( async (response) => {
