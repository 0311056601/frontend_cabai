...
const EditLahanForm = (props) => {
    var { handleSubmit } = props;

    var dataLahan = props.DataLahan;

    const [isOpen, setIsOpen] = useState(false);
    const [lokasi_lat, setLat] = useState(dataLahan.latitude);
    const [lokasi_lng, setLng] = useState(dataLahan.longitude);
        ...
        <main className="c-main">
            <div className="container-fluid">
                <CCard>
                    <CCardHeader>
                        <CRow>
                            <CCol xs={9} md={10} lg={11} style={{ margin: "auto" }}>
                                <h4 style={{ margin: "auto" }}>Edit Lahan</h4>
                            </CCol>
                            <CCol>
                            ...
                            <CCol xs={6} md={6} lg={6}>
                                <CFormGroup>
                                    ...
                                    <Field
                                        ...
                                        name="nama_lahan"
                                        component="input"
                                        placeholder={dataLahan.nama_lahan}
                                        required={true}
                                    />
                                </CFormGroup>
                            </CCol>
                            <CCol xs={6} md={6} lg={6}>
                                <CFormGroup>
                                    ...
                                    <Field
                                        ...
                                        component="input"
                                        type="number"
                                        placeholder={dataLahan.luas_lahan}
                                        required={true}
                                    />
                                </CFormGroup>
                            </CCol>
                            ...
                            <CCol xs={12} md={12} lg={12}>
                                <CFormGroup>
                                    ...
                                    <Field
                                        ...
                                        component="textarea"
                                        type="text"
                                        placeholder={dataLahan.alamat_lahan}
                                        required={true}
                                    />
                                </CFormGroup>
                            </CCol>
                            ...
                            <CCol xs={6} md={6} lg={6}>
                                <CFormGroup>
                                    ...
                                    <Field
                                        ...
                                        component="input"
                                        type="text"
                                        placeholder={dataLahan.latitude}
                            ...
                            <CCol xs={6} md={6} lg={6}>
                                <CFormGroup>
                                    ...
                                    <Field
                                        ...
                                        component="input"
                                        type="text"
                                        placeholder={dataLahan.longitude}
                    ...
                    <CCardFooter>
                        <CButton type="submit" size="sm" color="danger">Update</CButton>
                    </CCardFooter>
                </CCard>
            </div>
        </main>
...
export default reduxForm({
  form: "EditLahan", // a unique identifier for this form
})(EditLahanForm);